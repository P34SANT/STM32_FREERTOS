...
//simple echo program with uart interrupt
...
int main(void)
{
  ...
  xTaskCreate(Simple_Transmitter , "Simple task to transmit  " , SIMPLE_TASK_STACK_SIZE ,NULL , 3 , NULL);// transmitter task higher priority but goes to block when no data to send
